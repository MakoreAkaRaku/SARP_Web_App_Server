...
function getClassesForColor(color: ButtonProps['color']) {
  switch (color) {
    ...
    case 'dark':
      return "border bg-gray-900 border-gray-600 text-gray-400 hover:text-white hover:bg-gray-600 focus:ring-gray-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 dark:border-gray-600 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-800";
    case 'green':
